...
interface DashboardState {
  ...
  setDataSource: (
    source: "production" | "test" | "mock" | null,
    url?: string,
  ) => void;
  setAnalysisData: (
    overall: any[],
...
export const useDashboardStore = create<DashboardState>((set) => ({
  ...
  setDataSource: (source, url) =>
    set({ dataSource: source, dataSourceUrl: url || null }),

  setAnalysisData: (overall, project, projectKey) =>
    set({
      overallSummaryData: overall,
      projectAnalysisData: project,
